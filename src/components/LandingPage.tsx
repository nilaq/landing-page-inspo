...
const LandingPage = () => {
    return (
        <div className='dark flex min-h-screen w-full flex-row justify-center bg-background antialiased selection:bg-[#00fde01b] selection:text-[#2cffd1cb] dark:bg-[#05050a]'>
